...
# Create Discrete Fourier Transform (DFT) waveform
# DFT shows frequency domain representation - discrete frequency components
t = np.linspace(0, 4*np.pi, width)
# Sum of discrete frequency components (DFT representation)
waveform = (np.sin(t) + 
            0.6 * np.sin(2*t) + 
            0.4 * np.sin(3*t) + 
            0.3 * np.sin(4*t) + 
...
# Draw discrete frequency spectrum bars on the right (DFT characteristic)
...
print("DFT logo generated successfully!")
